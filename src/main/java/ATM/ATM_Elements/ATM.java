 ...
 * field which undergo their various operations, such as refilling the ATM or making transactions
 */
public class ATM {
    ...
    private static void writeFile(String i){
        try{
            ...
            File the_file = new File("alert.txt");
            if (!the_file.exists()){
                the_file.createNewFile();
            }
            BufferedWriter bw = new BufferedWriter(new FileWriter(the_file, true));
    ...
    //if any of $5, $10, $20, and $50 bills fall in quantity below 20, throw an alert to alert text file

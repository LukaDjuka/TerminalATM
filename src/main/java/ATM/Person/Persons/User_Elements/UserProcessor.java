...
public class UserProcessor {
     ...
     * @param targetUser The User that is being sent the Request
     */
    public void requestJointAccountCreation(UserStatus accountType, User sourceUser, User targetUser){ // Account Type ENUM, USER A(Requesting), USER B(One it Request to), USER B Accounts

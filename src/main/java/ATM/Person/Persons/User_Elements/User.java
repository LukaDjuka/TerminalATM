...
public class User extends Person{
    ...
    /**
     * This is a hashmap that contains the various accounts that a User can have, the key is the Eunm UserStatus and
     * the values are ArrayLists which contain the accounts of the specfic key type based on the Enum value
     * (CREDIT_CARD as the Enum and the ArrayList has all of the Credit Card accounts that the User has)
     *
     */
     ...
     * The User its from and the User its going to (which is this User).
     */

...
public class Chequing extends  AssetAccounts {
    ...
    // Certain Chequing accounts are said to be primary and contain extra functionality
    public boolean is_primary;

    // Constructor for the creation of a new Chequing account. It's parents are all abstract so they have no constructor
     public Chequing(){
        balance = 0;
        is_primary = false;
        setDate();

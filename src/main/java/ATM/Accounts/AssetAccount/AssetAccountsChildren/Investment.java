...
public class Investment extends AssetAccounts{
    // HashMap to keep track of all stocks held by this account
    public HashMap<String, UserStock> stocks = new HashMap<>(); //of the form <tickersymbol : stock object>

    // Constructor for the creation of a new Investment account. It's parents are all abstract
    // so they have no constructor
    public Investment(){
        balance = 0;
        type = "Investment";
    }
